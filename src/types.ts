...
export const INITIAL_COMPONENTS: GasComponent[] = [
  { id: 1, name: "Резервоар за гориво", make: "", approvalNumber: "" },
  { id: 2, name: "Мултиклапан", make: "", approvalNumber: "" },
  { id: 3, name: "Пълначно устройство", make: "", approvalNumber: "" },
  { id: 4, name: "Изпарител", make: "", approvalNumber: "" },
  { id: 5, name: "Инжектори", make: "", approvalNumber: "" },
  { id: 6, name: "Електронен блок за управление", make: "", approvalNumber: "" },
  { id: 7, name: "Тръби и маркучи за газ", make: "", approvalNumber: "" },
];

export const COMPONENT_OPTIONS: Record<string, Record<string, string[]>> = {
  "Резервоар за гориво": {
    "STEP": ["E7-67R01-612503", "E7-67R01-612508", "E7-67R01-00237-2", "E7-67R01-02606-4", "E7-67R01-02606-3", "E7-67R01- 02606-2", "E6-67R03- 0037", "E7-67R01-1031802", "E37-67R01-0040", "E7-67R01-667406", "E7-67R01-1031808", "E7-67R01-612501", "E7-67R01-1045113", "E7-67R01- 0160302", "E7-67R01-612504", "E7-67R01-612505", "E7-67R01-0160302"],
...
export const BRAND_KITS: { [key: string]: Partial<GasComponent>[] } = {
  "AEB": [
    ...
    { name: "Инжектори", make: "RAIL", approvalNumber: "E8-67R01-4303" },
  ...
  "BRC": [
    { name: "Резервоар за гориво", make: "STEP", approvalNumber: "E7-67R01-612503" },
    { name: "Мултиклапан", make: "BRC", approvalNumber: "E13-67R01-0004" },
    { name: "Пълначно устройство", make: "BRC", approvalNumber: "E13-67R01-0009" },
